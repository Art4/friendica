...
- Remove usage of `\Friendica\BaseModule::run()`, override `handleRequest(\Psr\Http\Message\ServerRequestInterface)` instead in your module class.
   ...
   *After*
   ...
   class MyModule extends BaseModule
   {
       ...
       {
           // custom logic — use $this->getServerRequest() for PSR-7 request access
